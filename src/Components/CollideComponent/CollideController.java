...
import static MyMath.Constants.timeStep;
...
public class CollideController {
    ...
    private static boolean areCollide(GameObject o1, GameObject o2){
        return getDeltaVector(o1, o2) != null;
    }

    private static void calcVelocityAfterCollide(CircleModel first, CircleModel second) {
        if(!areCollide(first, second)) return;
        ...
        //first.move(first.velocity().mul(t0));
        //second.move(second.velocity().mul(t0));
    }
